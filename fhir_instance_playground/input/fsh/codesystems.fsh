CodeSystem: H2OHouseholdCodeSystem
Id: H2OHouseholdCodeSystem
...
* #single "Single household" "Single household"
* #single ^designation.language = #de
* #single ^designation.value = "Einzelhaushalt"
* #shared "Shared household" "Shared household"
* #shared ^designation.language = #de
* #shared ^designation.value = "Gemeinsamer Haushalt"
* #facility "Nursing facility" "Nursing facility"
* #facility ^designation.language = #de
* #facility ^designation.value = "Pflegeeinrichtung"
* #without "Without household" "Without household"
* #without ^designation.language = #de
* #without ^designation.value = "Ohne Wohnung"


CodeSystem: ISCED2011EducationLevels
Id: ISCED2011EducationLevels
